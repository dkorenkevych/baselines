    ...
    def _init(self, ob_space, ac_space, hid_size, num_hid_layers, gaussian_fixed_var=True):
        ...
        with tf.variable_scope('vf'):
            ...
            for i in range(num_hid_layers):
                ...
                last_out = LayerNormalization()(last_out)
        ...
        self._act = U.function([stochastic, ob], [ac, mean, self.vpred])

    def act(self, stochastic, ob):
        ac1, mean1, vpred1 =  self._act(stochastic, ob[None])
        return ac1[0], mean1[0], vpred1[0]
